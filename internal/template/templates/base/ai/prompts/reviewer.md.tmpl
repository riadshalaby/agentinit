...
- If the session was interrupted, reload `AGENTS.md`, `.ai/TASKS.md`, `.ai/PLAN.md`, and `.ai/REVIEW.md` before acting.
- Compare implementation changes against `.ai/PLAN.md`.
- Validate compliance with project and workflow rules in `AGENTS.md`.
