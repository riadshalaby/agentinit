...
- If the session was interrupted, reload `AGENTS.md`, `.ai/AGENTS.md`, `.ai/TASKS.md`, `.ai/PLAN.md`, and `.ai/REVIEW.md` before acting.
- Compare implementation changes against `.ai/PLAN.md`.
- Validate compliance with project rules in `AGENTS.md` and workflow rules in `.ai/AGENTS.md`.
