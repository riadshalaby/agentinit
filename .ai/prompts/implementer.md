...
- If the session was interrupted, reload `CLAUDE.md`, `.ai/TASKS.md`, `.ai/PLAN.md`, `.ai/REVIEW.md`, and `.ai/TEST_REPORT.md` before acting when rework or failed-test follow-up may apply.
