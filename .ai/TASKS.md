...
| T-004 | Documentation improvements in README.md | claude | codex | claude | ready_for_test | README covers re-init behavior, manual vs auto comparison table, step-by-step manual flow, step-by-step auto flow, MCP server section | `README.md`; `go fmt ./...`; `go vet ./...`; `go test ./...` | test |
