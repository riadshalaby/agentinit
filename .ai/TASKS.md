...
| T-002 | MCP server skeleton (Cobra subcommand + mcp-go + stdio) | claude | codex | claude | ready_for_review | `agentinit mcp` starts MCP server on stdio; responds to `initialize`; tests pass | `go test ./...` PASS | review |
