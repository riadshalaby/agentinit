...
| T-002 | Cap `session_get_output` with `limit` parameter | `ready_for_implement` | Output never exceeds `limit` bytes; default 20KB; pagination works via offset | n/a | implement |
