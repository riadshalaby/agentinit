...
| T-003 | Add pre-flight checks to cycle bootstrap | claude | codex | claude | ready_for_review | ai-start-cycle.sh fails early on dirty tree, untracked files, missing gh; live and template in sync; tests pass | `go fmt ./...`; `go vet ./...`; `go test ./...` | review |
