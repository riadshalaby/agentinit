...
| T-002 | Add Tool Preferences section to CLAUDE.md and CLAUDE.md.tmpl | claude | codex | claude | ready_for_review | Own CLAUDE.md has Tool Preferences section; CLAUDE.md.tmpl has same section; rendered output contains rg/fd/bat/jq rules; go test passes | `go vet ./...`; `go test ./...` | review |
