...
| T-004 | Add `agentinit update` command with manifest-based and fallback file management | claude | codex | claude | ready_for_test | `agentinit update` refreshes managed files, preserves user content, supports `--dry-run`, works with and without manifest; tests pass | PASS | test |
