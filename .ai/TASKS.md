...
| T-004 | Update all tests for unified scaffold | claude | codex | claude | ready_for_test | All tests pass; no auto-vs-manual branching in assertions; PO files asserted as always present; `go test ./...` green | `go fmt ./...`; `go test ./...`; `go vet ./...` | test |
