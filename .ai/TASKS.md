...
| T-005 | Manual validation cycle with restructured files | claude | — | claude | ready_for_test | Full cycle completes; conventional commits, no Co-Authored-By, validations run; no `.ai/AGENTS.md` references | PASS | test |
