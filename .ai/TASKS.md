...
| T-002 | Update scaffold code (result.go), tests (engine_test.go, scaffold_test.go), and README.md template to reflect new file layout | claude | codex | claude | ready_for_test | AC 9-11 from PLAN.md: all tests pass, defaultKeyPaths updated, README file map accurate | `go fmt ./...`; `go vet ./...`; `go test ./...` | test |
