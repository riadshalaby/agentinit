...
| T-002 | Standardize HANDOFF.md entry format | claude | codex | claude | ready_for_review | HANDOFF.template.md defines table-based format; all role prompts reference it; live and templates in sync; tests pass | `go fmt ./...`; `go vet ./...`; `go test ./...` | review |
