...
| T-002   | Update reviewer, PO, HANDOFF template — align with no-WIP-commit flow                                                                        | done                 | Reviewer prompt mentions working-tree review; HANDOFF template `Commit` field updated; templates and live files in sync; `go test ./...` passes                                                                           | `go fmt ./...`, `go vet ./...`, `go test ./...` | none |
