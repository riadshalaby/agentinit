...
| T-002 | Claude settings templates: scaffold .claude/settings.json and settings.local.json | claude | codex | claude | ready_for_test | agentinit init produces both files; settings.local.json has validation + git permissions; go test passes | go fmt ./...; go vet ./...; go test ./... | test |
