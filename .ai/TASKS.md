...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| T-001 | Merge `.ai/AGENTS.md` into `AGENTS.md` with managed markers; update all references; delete `.ai/AGENTS.md` | claude | codex | claude | ready_for_test | Single `AGENTS.md` with markers; no file references `.ai/AGENTS.md`; all prompts point to `AGENTS.md` | PASS_WITH_NOTES | test |
