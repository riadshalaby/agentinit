...
| T-002 | Add release-please configuration | claude | codex | claude | ready_for_test | `.release-please-manifest.json`, `release-please-config.json`, `.github/workflows/release-please.yml` exist; workflow triggers on push to main | `.release-please-manifest.json`; `release-please-config.json`; `.github/workflows/release-please.yml`; `go fmt ./...`; `go vet ./...`; `go test ./...` | test |
