...
| T-004 | Remove redundant CONTEXT.md from scaffold | claude | codex | claude | done | CONTEXT.md.tmpl and .ai/CONTEXT.md deleted; tests updated and passing; no remaining references | `go fmt ./...`; `go vet ./...`; `go test ./...`; `rg -n "CONTEXT\\.md" .` | — |
