...
| T-003 | Move Commit Conventions section from root AGENTS.md to .ai/AGENTS.md in both templates and live repo files; update test assertions | claude | codex | claude | ready_for_review | Commit Conventions section absent from AGENTS.md.tmpl and AGENTS.md; present in ai/AGENTS.md.tmpl and .ai/AGENTS.md; engine_test.go asserts it in .ai/AGENTS.md; all tests pass | `go fmt ./...`; `go vet ./...`; `go test ./...` | review |
