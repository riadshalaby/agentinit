...
| T-003 | Rewrite `AGENTS.md.tmpl` with markers; delete `ai/AGENTS.md.tmpl`; add manifest generation to scaffold | claude | codex | claude | ready_for_review | `agentinit init` produces merged `AGENTS.md`, no `.ai/AGENTS.md`, and `.ai/.manifest.json`; all tests pass | PASS | review |
