...
- Mode is selected by the launcher prompt/context:
  ...
  - Convenience wrappers:
    ...
    - `agentinit plan [agent] [agent-options...]` (cross-platform launcher; same defaults as `scripts/ai-plan.sh`)
    - `agentinit implement [agent] [agent-options...]` (cross-platform launcher; same defaults as `scripts/ai-implement.sh`)
    - `agentinit review [agent] [agent-options...]` (cross-platform launcher; same defaults as `scripts/ai-review.sh`)
